...
export default function AddDepartment() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const response = await axios.post("https://backend-site-mongo-db-atlast.vercel.app/api/department/add", department, { headers: { "Authorization": `Bearer ${localStorage.getItem('token')}` } })
