...
export default function AddSalary() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const response = await axios.post('https://backend-site-mongo-db-atlast.vercel.app/api/salary/add', salary, { headers: { "Authorization": `Bearer ${localStorage.getItem('token')}` } })
